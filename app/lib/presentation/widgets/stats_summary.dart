              ...
              children: [
                ...
                Expanded(
                  child: userStatsAsync.when(
                    loading: () => _buildStatChip(
                      ...
                      chipColorDark: AppTheme.chipYellowDark,
                      value: '...',
                      label: 'streak',
                    ),
                ...
                Expanded(
                  child: _buildStatChip(
                    ...
                    chipColorDark: AppTheme.chipBlueDark,
                    value: '$groupCount',
                ...
                Expanded(
                  child: totalPeopleAsync.when(
                    loading: () => _buildStatChip(
                      ...
                      chipColorDark: AppTheme.chipGreenDark,
                      value: '...',
                      label: 'people',
                    ),
                    error: (_, __) => _buildStatChip(
  ...
  Widget _buildStatChip(
    ...
    return Container(
      ...
      decoration: NeoStyles.chipDecoration(
        backgroundColor: isDark ? chipColorDark : chipColor,
        isDark: isDark,
